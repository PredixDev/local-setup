...
```
bash <( curl https://github.com/predix-edgemanager-ui/local-setup/master/setup-mac.sh )
```
...
```
bash <( curl https://github.com/predix-edgemanager-ui/local-setup/master/setup-mac.sh ) --git --cf
```
...
[Maven] (https://maven.apache.org) | --maven |[Python3] (https://www.python.org) | --python3 |
[rbenv] (http://rbenv.org), [ruby-build] (https://github.com/rbenv/ruby-build), [ruby] (https://www.ruby-lang.org) 

[cf-uaac] (https://github.com/cloudfoundry/cf-uaac) | --uaac | This is not installed by default
